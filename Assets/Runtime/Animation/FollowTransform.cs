...
namespace Oculus.Interaction.Bullshiddo
{
    ...
    /// Used to make the Prompts follow their target objects and face the user.
    /// </summary>
        ...
        public struct FollowPosition
        {
            ...
            private Vector3 GetPositionOffset(Transform transform, Transform Source)
            {
                switch (PositionOffsetSpace)
                {
                    ...
                    default: throw new System.Exception($"Can't handle offset space {PositionOffsetSpace}");
                }
            }
        }
        ...
        public struct FollowRotation
        {
            ...
            private Vector3 GetUpDirection(Transform forTransform, Transform fromSource)
            {
                switch (UpDirection)
                {
                    ...
                    default: throw new System.Exception($"Can't handle offset space {UpDirection}");
                }
            }
        }
