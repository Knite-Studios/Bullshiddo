...
namespace Oculus.Interaction.Bullshiddo
{
    ...
    /// Used to animate various things over time.
    /// </summary>
    public static class TweenRunner
    {
        ...
        class TweenUpdater : MonoBehaviour
        {
            ...
            private void Update()
            {
                UpdateTweens(_tweens, Bullshiddo.Tween.UpdateTime.Update);
            }

            private void LateUpdate()
            {
                UpdateTweens(_tweens, Bullshiddo.Tween.UpdateTime.LateUpdate);
            }
    ...
    public class Tween
    {
        ...
        static float EaseValue(float t, Ease ease)
        {
            ...
            switch (ease)
            {
                ...
                default: throw new Exception($"Can't ease {ease}");
            }
