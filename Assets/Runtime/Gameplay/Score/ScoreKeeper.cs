...
{
    /// <summary>
    /// Tracks the consecutive hits and their velocity to calculate the score.
    /// </summary>
    public class ScoreKeeper : MonoBehaviour
    {
        [SerializeField, Tooltip("The number of consecutive hits required to up the score multiplier.")]
