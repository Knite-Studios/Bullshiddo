...
{
    /// <summary>
    /// Adjusts the height of the player so it remains consistent regardless of actual height.
    /// </summary>
    public class HeightAdjustment : MonoBehaviour
    {
        ...
        {
            yield return null; // Takes 2 frames for the camera to get its position
            yield return null;
            SetHeight();
        }
