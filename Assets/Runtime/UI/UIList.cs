...
namespace Oculus.Interaction.Bullshiddo
{
    ...
    public class UIList : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        public IEnumerator UpdateUIRoutine()
        {
            ...
            for (int i = 0; i < _list.Count; i++)
            {
                ...
                // Order the siblings by their order in the list
        ...
        public struct DefaultLifecycleHandler : ILifeCycleHandler
        {
            ...
            {
                // Sometimes it's inconvenient not to have an actual prefab and just instantiate copies of a child
            ...
            private GameObject GetInstance(Transform parent)
            {
    ...
    {
        /// <summary>
        /// Called by UIList on a new instance when it's created, used to allow spawned UI to populate itself.
        /// </summary>
